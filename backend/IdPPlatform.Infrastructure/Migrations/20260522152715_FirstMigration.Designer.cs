...
namespace IdPPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260522152715_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.IdentityProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.OidcRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.PlatformRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.UserCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.UserPlatformRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.OidcAuthorizationCode", b =>
                {
                    b.HasOne("IdPPlatform.Domain.Entities.ApplicationClient", "ApplicationClient")
                        .WithMany()
                        .HasForeignKey("ApplicationClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IdPPlatform.Domain.Entities.AuthSession", "AuthSession")
                        .WithMany()
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.User", b =>
                {
                    ...
                    b.OwnsOne("IdPPlatform.Domain.ValueObjects.PhotoUrl", "PhotoUrl", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IdPPlatform.Domain.Entities.UserPlatformRole", b =>
                {
                    b.HasOne("IdPPlatform.Domain.Entities.PlatformRole", "Role")
