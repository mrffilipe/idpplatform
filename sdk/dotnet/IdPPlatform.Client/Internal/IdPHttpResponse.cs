...
using IdPPlatform.Client.Exceptions;

namespace IdPPlatform.Client.Internal;

internal static class IdPHttpResponse
{
    ...
    public static async Task EnsureSuccessAsync(HttpResponseMessage response, CancellationToken cancellationToken)
    {
        ...
        throw new IdPApiException(response.StatusCode, title, detail ?? body, body);
    }
