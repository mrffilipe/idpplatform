...
namespace IdPPlatform.AspNetCore.TenancyKit;

public static class IdPPlatformTenancyKitServiceCollectionExtensions
{
    public static IServiceCollection AddIdPPlatformTenancyKit<TTenantInfo>(
